...
Write the full page copy organized by section: hero (3 headline options with rationale), social proof, problem/pain, solution/benefits, how it works, testimonials, FAQ, and final CTA (3 options).

For each headline and CTA, explain why you chose it. Include meta title + description for SEO.

Quality rules:
- No fabricated statistics, testimonials, or client names
- Every CTA must be specific (never "Learn More" or "Submit")
...
- Specific > vague. "Cut reporting from 4 hours to 15 minutes" not "Save time"
```
...
|--------|--------|---------------|
| Word count | 25% | 2,500-4,000 words for full pages. Under 1,000 = thin content. |
| Structure | 20% | Has comparison table, FAQ section, 3+ H2s, 5+ H3s, 2+ CTAs |
| Specificity | 20% | Numbers, timeframes, concrete details in headlines and benefits |
| Freshness | 20% | Current year references, up-to-date examples, no stale data |
| CTR potential | 15% | Would you click this headline in search results? Target 3%+ CTR. |

**Score 80+**: Ready to publish
**Score 60-79**: Needs another pass
**Score under 60**: Major rewrite needed
